    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @else
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow group" wire:key="p-{{ $product->id }}">
                    ...
                    <div class="p-4">
                        ...
                        <button wire:click="addToCart({{ $product->id }})"
                            ...
                            class="mt-3 w-full py-2 px-4 rounded-xl text-sm font-semibold transition-all
                                {{ $product->isInStock() ? 'bg-indigo-600 text-white hover:bg-indigo-700 active:scale-95' : 'bg-gray-100 text-gray-400 cursor-not-allowed' }}">
